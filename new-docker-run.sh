...
GALLERY__MARIADB__HOST=${GALLERY__MARIADB__HOST:=localhost}
GALLERY__MARIADB__PORT=${GALLERY__MARIADB__PORT:=3306}
GALLERY__MARIADB__USERNAME=${GALLERY__MARIADB__USERNAME:=root}
GALLERY__MARIADB__PASSWORD=${GALLERY__MARIADB__PASSWORD:=root}
GALLERY__MARIADB__DATABASE=${GALLERY__MARIADB__DATABASE:=gallery}
...
docker run \
  ...
  -e GALLERY__MARIADBL__HOST=$GALLERY__MARIADB__HOST \
  -e GALLERY__MARIADB__PORT=$GALLERY__MARIADB__PORT \
  -e GALLERY__MARIADB__USERNAME=$GALLERY__MARIADB__USERNAME \
  -e GALLERY__MARIADB__PASSWORD=$GALLERY__MARIADB__PASSWORD \
  -e GALLERY__MARIADB__DATABASE=$GALLERY__MARIADB__DATABASE \
